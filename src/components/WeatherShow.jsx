        ...
        <>
            ...
            <Container>
                ...
                <Col xs={8} md={5} className="text-center mt-5 weatherContainer">
                    <Row className="">
                    <h1 className="display-2 text-white">{capitalizedCityName}</h1>
                    </Row>
                    <Row>
                    <h2 className="display-1 mt-2 text-white ">{temperature}°C</h2>
                    <p className="h3 mt-2 text-white">{`Percepita: ${temperaturePerc}°C`}</p>
                    </Row>
